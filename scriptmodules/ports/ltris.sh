...
function configure_ltris() {
	...
	local binary="XINIT:/usr/games/ltris"
	if ! isPlatform "rpi"; then
    addPort "$md_id" "ltris" "ltris - Open Source Tetris game" "$binary"
	else addPort "$md_id" "ltris" "ltris - Open Source Tetris game" "/usr/games/ltris"
	fi
}
