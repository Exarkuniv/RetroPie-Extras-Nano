...
function depends_yquake2() {
      getDepends libgl1-mesa-dev libglu1-mesa-dev libogg-dev libopenal-dev libsdl2-dev libvorbis-dev zlib1g-dev libcurl4-openssl-dev

    getDepends 
}

function sources_yquake2() {
    gitPullOrClone "$md_build" https://github.com/yquake2/yquake2.git "QUAKE2_8_20"
}
