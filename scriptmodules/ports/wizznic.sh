...
function configure_wizznic() {
    ...
    addPort "$md_id" "wizznic" "Wizznic - Puzznic clone" "pushd $md_inst; xinit $md_inst/wizznic -f; popd"
	else  addPort "$md_id" "wizznic" "Wizznic - Puzznic clone" "pushd $md_inst; $md_inst/wizznic -f; popd"
	fi
}
