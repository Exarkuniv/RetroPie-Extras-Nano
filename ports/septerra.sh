...
function install_bin_septerra() {
    downloadAndExtract "https://github.com/M-HT/SR/releases/download/septerra_v1.04.0.10/SepterraCore-Linux-arm-aarch64-v1.04.0.10-EXPERIMENTAL.tar.gz" "$md_inst"
}
