...
function configure_freesynd() {
	...
	local binary="XINIT:$md_inst/freesynd"
	if ! isPlatform "rpi"; then
    addPort "$md_id" "freesynd" "FreeSynd - Syndicate Engine" "$binary" 
	else addPort addPort "$md_id" "freesynd" "FreeSynd - Syndicate Engine" "$md_inst/freesynd"
    fi	
}
