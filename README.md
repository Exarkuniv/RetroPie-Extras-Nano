...
to get the **rigelengine, dxx-rebirth, nblood, rednukem, and pcexhumed**  script to install, you need to change the GCC and GCC++ from version 7 to version 10 and 11
